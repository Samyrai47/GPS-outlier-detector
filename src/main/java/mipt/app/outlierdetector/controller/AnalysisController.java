...
public class AnalysisController {
  ...
  public String analyze(
    ...
    pythonScriptService.runSync(
        inputPath, outputPath, geojsonPath, stderrPath, jobDir, algorithm, window);
  ...
  public ResponseEntity<Resource> downloadResultPkl(@PathVariable UUID requestId) throws Exception {
    ...
    return ResponseEntity.ok()
        ...
        .header("Content-Disposition", "attachment; filename=\"gps_outliers.pkl\"")
        .body(resource);
  }
}
